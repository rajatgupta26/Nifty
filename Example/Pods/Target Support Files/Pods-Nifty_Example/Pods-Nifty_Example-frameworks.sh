...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/NSAttributedString-DDHTML/NSAttributedString_DDHTML.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nifty/Nifty.framework"
